        ...
        <div className="flex items-center justify-between h-16 border-b border-gray-800/50">
          ...
          {walletAddress ? (
            <button
              ...
              className="px-6 py-2.5 bg-gradient-to-r from-gray-600/60 to-red-600/60 rounded-lg backdrop-blur-sm border border-gray-600/30 shadow-lg shadow-red-500/10 hover:shadow-red-500/20 hover:scale-[1.02] transition-all duration-300"
            >
              <span className="text-sm font-semibold bg-gradient-to-r from-gray-400 to-red-400 bg-clip-text text-transparent">
